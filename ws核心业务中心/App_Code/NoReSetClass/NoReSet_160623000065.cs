...
public class NoReSet_160623000065
{
    ...
    public DataSet NRS_ADD(DataTable parameter_forUI)
    {
        ...
        string guid = CombGuid.GetMewIdFormSequence("ZZZ_moneyQTTKD");
        param.Add("@MID", guid);
        param.Add("@Mzt", "草稿");
        ...
        alsql.Add("INSERT INTO ZZZ_moneyQTTKD(MID, M_HID, Mpz, Mje,M_MID,M_Mpz, Mbeizhu, Mzt, Mchuangjianren) VALUES(@MID, @M_HID, @Mpz, @Mje,@M_MID,@M_Mpz, @Mbeizhu, @Mzt, @Mchuangjianren)");
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        alsql.Add("UPDATE ZZZ_moneyQTTKD SET M_HID=@M_HID,Mpz=@Mpz,Mje=@Mje,M_MID=@M_MID,M_Mpz=@M_Mpz,Mbeizhu=@Mbeizhu where MID=@MID and Mzt='草稿' ");
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select top 1 * from View_ZZZ_moneyQTTKD_ex where MID=@MID", "数据记录", param);
