...
public class NoReSet_160623000067
{
    ...
    public DataSet NRS_ADD(DataTable parameter_forUI)
    {
        ...
        //以可排序guid方式生成
        //WID, Wsqrq, Wwenti, Wbeizhu, Wzt, Wchuangjianren, Waddtime
        string guid = CombGuid.GetMewIdFormSequence("ZZZ_WXQQ");
        param.Add("@WID", guid);
        param.Add("@Wzt", "已申请");
        param.Add("@Wsqrq", ht_forUI["Wsqrq"].ToString());
        param.Add("@Wwenti", ht_forUI["Wwenti"].ToString());
        param.Add("@Wbeizhu", ht_forUI["Wbeizhu"].ToString());
        param.Add("@Wchuangjianren", ht_forUI["yhbsp_session_uer_UAid"].ToString());



        alsql.Add("INSERT INTO ZZZ_WXQQ(WID, Wsqrq, Wwenti, Wbeizhu, Wzt, Wchuangjianren) VALUES(@WID, @Wsqrq, @Wwenti, @Wbeizhu, @Wzt, @Wchuangjianren)");
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        ArrayList alsql = new ArrayList();
        Hashtable param = new Hashtable();
        param.Add("@WID", ht_forUI["idforedit"].ToString());
        param.Add("@Wsqrq", ht_forUI["Wsqrq"].ToString());
        param.Add("@Wwenti", ht_forUI["Wwenti"].ToString());
        param.Add("@Wbeizhu", ht_forUI["Wbeizhu"].ToString());

        alsql.Add("UPDATE ZZZ_WXQQ SET Wsqrq=@Wsqrq,Wwenti=@Wwenti,Wbeizhu=@Wbeizhu where WID=@WID  ");
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select top 1 * from View_ZZZ_WXQQ_ex where WID=@WID", "数据记录", param);
