...
public class NoReSet_160623000066
{
    ...
    public DataSet NRS_ADD(DataTable parameter_forUI)
    {
        ...
        string guid = CombGuid.GetMewIdFormSequence("ZZZ_moneyWYFSKD");
        param.Add("@MID", guid);
        param.Add("@Mzt", "草稿");
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select top 1 * from View_ZZZ_moneyWYFSKD_ex where MID=@MID", "数据记录", param);
