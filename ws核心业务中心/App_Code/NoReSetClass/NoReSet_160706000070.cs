...
public class NoReSet_160706000070
{
    ...
    public DataSet NRS_ADD(DataTable parameter_forUI)
    {
        ...
        string guid = CombGuid.GetMewIdFormSequence("ZZZ_HTchewei");
        param.Add("@HID", ht_forUI["HID"].ToString());
        param.Add("@Hzhuangtai", ht_forUI["Hzhuangtai"].ToString());
        ...
        alsql.Add("INSERT INTO ZZZ_HTchewei(HID, Hzhuangtai, H_CID, H_FID, Hdaoqiriqi, Hfkfs, Hje, Hshengxiaoriqi, Hqiandingriqi, Hbeizhu, Hchuangjianren) VALUES(@HID, @Hzhuangtai, @H_CID, @H_FID, @Hdaoqiriqi, @Hfkfs, @Hje, @Hshengxiaoriqi, @Hqiandingriqi, @Hbeizhu, @Hchuangjianren)");
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        alsql.Add("UPDATE ZZZ_HTchewei SET Hzhuangtai=@Hzhuangtai, H_CID=@H_CID, H_FID=@H_FID, Hdaoqiriqi=@Hdaoqiriqi, Hfkfs=@Hfkfs, Hje=@Hje, Hshengxiaoriqi=@Hshengxiaoriqi, Hqiandingriqi=@Hqiandingriqi, Hbeizhu=@Hbeizhu where HID=@HID and Hzhuangtai='草稿' ");
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select top 1 * from View_ZZZ_HTchewei_ex where HID=@HID", "数据记录", param);
