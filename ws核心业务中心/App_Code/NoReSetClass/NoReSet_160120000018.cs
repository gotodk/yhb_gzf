...
public class NoReSet_160120000018
{
    /// <summary>
    ...
    public DataSet NRS_EDIT(DataTable parameter_forUI)
    {
        ...
        param.Add("@YID", ht_forUI["idforedit"].ToString());
        param.Add("@YSTR", ht_forUI["YSTR"].ToString());


        alsql.Add("UPDATE ZZZ_ZFCMJ SET  YSTR=@YSTR  where YID =@YID ");
    ...
    public DataSet NRS_EDIT_INFO(DataTable parameter_forUI)
    {
        ...
        return_ht = I_DBL.RunParam_SQL("select  top 1 * from ZZZ_ZFCMJ where YID=@YID", "数据记录", param);
