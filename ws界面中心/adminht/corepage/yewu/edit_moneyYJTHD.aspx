<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_moneyYJTHD.aspx.cs" Inherits="yewu_edit_moneyYJTHD" %>
            ...
            function add_anniu_spsp()
            {
                ...
                if ($("#fifsssss_Mzt").text() == "草稿") {
                    ...
                    $(document).on('click', "#" + bjm + "_top", function () {
                        ...
                        begin_ajax("shengxiao", getUrlParam("idforedit"), "160623000085")
