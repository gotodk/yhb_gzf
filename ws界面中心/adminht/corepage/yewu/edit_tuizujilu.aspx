<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="edit_tuizujilu.aspx.cs" Inherits="yewu_edit_tuizujilu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
             jQuery(function ($) {
                 ...
                 var dfx_str_rzhtbh = "#show_searchopenyhbspgogo_TZ_HID";
