<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="alluseryuyue_list_nosystem.aspx.cs" Inherits="alluseryuyue_list_nosystem" %>
        ...
        <div class="col-xs-12">
            <!-- PAGE CONTENT BEGINS -->
                ...
                <input class="form-control search-query" type="text" id="ODR_old_US_title_forsearch" name="ODR_old_US_title_forsearch" />
                 ...
                 <label>预约方：</label>
                <input class="form-control search-query" type="text" id="yyf_name_forsearch" name="yyf_name_forsearch" />
                 <label>服务方：</label>
...
<asp:Content ID="Content4" ContentPlaceHolderID="sp_script" runat="Server">
    ...
    <script type="text/javascript">
        ...
        var jkname_page1 = encodeURIComponent("我的预约分页数据");//获取分页数据接口名
        ...
        jQuery(function ($) {
            ...
            */
            ...
            jQuery(grid_selector).jqGrid({
                ...
                subGrid: false,
                //data: grid_data,
                url: "/ajaxpagedemo.aspx?jkname=" + jkname_page1 + "&thisut=all_but_no_system",
                datatype: "xml",
                mtype: "POST",
                xmlReader: {
                    root: "NewDataSet",
                ...
                colModel: [
                    ...
                    { name: '隐藏编号', xmlmap: 'ODR_id', hidden: true },
                    { name: '预约单号', xmlmap: 'ODR_id', index: 'ODR_id', width: 100  },
                    { name: '服务方', xmlmap: 'fwf_name', index: 'fwf_name', width: 150 },
                    { name: '预约方', xmlmap: 'yyr_name', index: 'yyr_name', width: 150 },
                    {
                        name: '课程名', xmlmap: 'ODR_old_US_title', index: 'ODR_old_US_title', width: 150, formatter: 'showlink', formatoptions: { baseLinkUrl: '/yylook.aspx', target: '_blank', showAction: '', addParam: '', idName: 'ODR_id' }
                    },
                    { name: '学员姓名', xmlmap: 'ODR_goname', index: 'ODR_goname', width: 80 },
                    { name: '家长姓名', xmlmap: 'ODR_backname', index: 'ODR_backname', width: 80 },
                    { name: '联系方式', xmlmap: 'ODR_lianxi', index: 'ODR_lianxi', width: 150 },
                    { name: '预约备注', xmlmap: 'ODR_beizhu', index: 'ODR_beizhu', width: 100 },
                    { name: '预约时间', xmlmap: 'ODR_addtime', index: 'ODR_addtime', width: 150, formatter: 'date', formatoptions: { srcformat: 'Y-m-d H:i:s', newformat: 'Y-m-d H:i:s' } },
                    { name: '预约单状态', xmlmap: 'ODR_zhuangtai', index: 'ODR_zhuangtai', width: 100 },
                    { name: '预约码', xmlmap: 'ODR_code', index: 'ODR_code', width: 100 },
                    
                    { name: '服务群体', xmlmap: 'ODR_old_US_mubiaoren', index: 'ODR_old_US_mubiaoren', width: 100 },
                    { name: '收费方式', xmlmap: 'ODR_old_US_sffs', index: 'ODR_old_US_sffs', width: 100 },
                    { name: '原价格', xmlmap: 'ODR_old_US_oldjg', index: 'ODR_old_US_oldjg', formatter: 'number', width: 100 },
                    { name: '优惠价格', xmlmap: 'ODR_old_US_goodjg', index: 'ODR_old_US_goodjg', formatter: 'number', width: 100 },
                { name: '服务方标注', xmlmap: 'ODR_fwf_bz_str', index: 'ODR_fwf_bz_str', width: 200 }
