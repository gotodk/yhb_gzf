<%@ Page Title="" Language="C#" MasterPageFile="~/adminht/MasterPageMain.master" AutoEventWireup="true" CodeFile="demo_tijiao_edit.aspx.cs" Inherits="demo_tijiao_edit" %>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <form class="form-horizontal hide" role="form" id="myform1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input readonly="readonly" data-rel="tooltip" type="text" id="idforedit" name="idforedit" data-placement="bottom" class="col-xs-12 col-sm-5" value='<%=idforedit %>' />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input readonly="readonly" data-rel="tooltip" type="text" id="zhanghao" name="zhanghao" placeholder="请输入…" title="需要电子邮件地址" data-placement="bottom" class="col-xs-12 col-sm-5" />
                                                    <div class="ValidErrInfo col-sm-12 no-padding-left"></div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label no-padding-right" for="fuwuqiyu"><i class="light-red">*  </i>服务区域：</label>

                                                <div class="col-sm-10">
                                                    <div class="yhb_city">
                                                    <select class="yhb_city_p" name="yhb_city_Promary" id="yhb_city_Promary">
                                                        <option value="0" selected>请选择省份</option>

                                                    </select>
                                                    <select class="yhb_city_c" name="yhb_city_City" id="yhb_city_City">
                                                        <option value="0" selected>请选择城市</option>
                                                    </select>
                                                    <select class="yhb_city_q" name="yhb_city_Qu" id="yhb_city_Qu">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label no-padding-right" for="dangetu">单个图片：</label>

                                                <div class="col-sm-10">
                                                     <uc1:upimageuc runat="server" ID="upimageuc1" Cloadingimg="" Csite="md" Cnowimg="" Ctitle="" Cisp="no" Cidname="dangetu1"   />
		...
		<script type="text/javascript">
		    jQuery(function ($) {
		        ...
		        $(document).on('click', buttonid1, function () {
		            if ($.trim($(editname_w).text()) != "" || $(editname_w).html().indexOf("img") >= 0) {
    ...
    <script type="text/javascript">
        ...
        function loadinfoajax1(dbid) {
            ...
            function callback(xml) {
                ...
                //处理编辑器，赋值。 
                $("#editor1").html($(xml).find('数据记录>Sbeizhu').text());
                ...
                //省市区赋值
                $("#yhb_city_Promary").val("1");
                $("#yhb_city_Promary").trigger('change');
                $("#yhb_city_City").val("1");
                $("#yhb_city_City").trigger('change');
                $("#yhb_city_Qu").val("1");
