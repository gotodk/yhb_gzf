namespace IPC配置更新工具
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label2.Text = "更新后，目标应用程序IPC目录要先清空,\r\n然后将本程序ForIPC目录中生成的新文件，拷贝到目标应用程序IPC目录中使用。";
            // 
            // button2
            // 
            ...
            this.button2.Text = "IPC(webservices)调用测试工具";
